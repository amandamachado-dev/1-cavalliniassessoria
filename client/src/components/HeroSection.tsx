/*
 * HeroSection — Cinematic fullscreen hero with image carousel crossfade
 * Design: Film noir, P&B images, orange accents, dramatic overlays
 */
...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* Cinematic Overlays */}
      <div className="absolute inset-0 z-[1] bg-gradient-to-r from-black/90 via-black/60 to-black/30" />
      ...
      {/* Content */}
      <div className="relative z-10 w-full max-w-[1280px] mx-auto px-4 sm:px-6 md:px-12 flex flex-col items-start justify-center min-h-[100svh] pt-20 pb-16">
        <div className="max-w-[750px] flex flex-col items-start text-left">
          {/* Badge */}
          <div
            className={`mb-6 overflow-hidden transition-all duration-700 delay-200 ${
          ...
          {/* Headline */}
          <h1
            className={`text-[2.5rem] sm:text-5xl md:text-6xl lg:text-[5rem] font-display font-medium tracking-tight text-white leading-[1.05] mb-6 drop-shadow-2xl transition-all duration-1000 delay-300 ${
              loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
            Segurança não
            <br className="hidden sm:block" /> se promete.{" "}
          ...
          {/* Subheadline */}
          <p
            className={`text-base sm:text-lg md:text-xl font-sans text-stone-300 leading-relaxed max-w-xl font-light mb-10 transition-all duration-1000 delay-500 ${
              loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
          ...
          {/* CTAs */}
          <div
            className={`flex flex-col sm:flex-row items-start sm:items-center gap-4 transition-all duration-1000 delay-700 ${
              loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
            <a
