...
export const ASSETS = {
  ...
  heroBg3: "https://d2xsxph8kpxj0f.cloudfront.net/310419663029960001/EJKLd5S4d8nwmwUsXsH3Mz/hero-sprinkler-bw-jRXAftjuhk7VvcRmD7PQJA.webp",
  ...
  corredorSeguro: "/assets/corredor-seguro_c5b7a5df.webp",
  extintor: "/assets/extintor_09ac19f4.webp",
  placa: "/assets/placa_1_48ca5828.webp",
  trabalhadores: "/assets/trabalhadores_595cd2db.webp",
  avcb: "/assets/avcb_b8632f27.webp",
  assessoriaReuniao: "/assets/assessoria-reuniao_8c0d0665.webp",
  projetos: "/assets/projetos_f4a883ee.webp",
  trabalhadorCostas: "/assets/trabalhador-costas-com-logo_0688fd68.webp",
  tresImgPeb: "/assets/3-img-peb_84c045be.webp",
  logoRedDesktop: "/assets/image-logo-red_86d9fe76.webp",
  logoRedMobile: "/assets/image-logo-red-mobile_64ce4e87.webp",
  extintorSemLogo: "/assets/extintor-image-sem-logo_0d7b21fe.webp",
  grafismo: "/assets/grafismo_cavallini2-removebg-preview_aea09a71.webp",

  // Logos (PNG for transparency)
  logoBrancoC: "/assets/logo-branco-laranja-c_38cd2c40.png",
  logoPretoC: "/assets/logo-preto-laranja-c_5d17b609.png",
  logoBrancoDark: "/assets/logo-branco-laranja-dark_05b55389.png",
  logoCompleta: "/assets/logo-completa_2678bbfc.png",
  logoSemFundo: "/assets/logo-semfundo_73f0f8a1.png",

  // Video
  fireExtinguisherVideo: "/assets/fire-extinguisher_3b11c291.mp4",
} as const;
...
export const PARTNER_LOGOS = [
  ...
  { name: "Coco Bambu", src: "/assets/coco-bambu-clean_818d0f37.png" },
  { name: "F1", src: "/assets/f1-logo_f600a2bc.png" },
  { name: "Interlagos", src: "/manus-storage/ChatGPTImage27dejun.de2026,18_46_28_1ebe5557.png" },
  { name: "COP30", src: "/assets/cop30-logo_3e7fc7df.png" },
  { name: "Goya Perfumaria", src: "/assets/goya-logo_70567333.png" },
  { name: "Pontuall", src: "/assets/pontuall-clean_c6e2a96b.png" },
] as const;
...
export const SERVICES = [
  {
    ...
    image: "/assets/avcb_b8632f27.webp",
    ...
    deliverables: [
      "Avaliação completa e vistoria prévia",
  ...
  },
  {
    ...
    subtitle: "Avaliação e Planejamento Estratégico",
    ...
    image: "/assets/assessoria-reuniao_8c0d0665.webp",
    features: ["Avaliação de riscos", "Plano de adequação", "Orientação normativa", "Acompanhamento contínuo"],
    pageTitle: "Consultoria técnica com visão estratégica e rigor normativo.",
    pageDescription: "Nossa consultoria vai além da avaliação inicial. Analisamos cada detalhe do seu imóvel, identificamos riscos e propomos soluções práticas e economicamente viáveis para garantir a conformidade total com as normas de segurança contra incêndio.",
  ...
  },
  {
    ...
    image: "/assets/projetos_f4a883ee.webp",
  ...
  },
  {
    ...
    image: "/assets/qgSxK2jJBPx9_852b25b8.jpg",
...
export const PORTFOLIO_ITEMS = [
  {
    ...
    image: "/assets/hII4ZZMFSkzd_274e2eac.jpg",
    logoSrc: "/assets/coco-bambu-clean_818d0f37.png",
    featured: true,
  },
  {
    id: "f1-formula-1",
    ...
    image: "/assets/SSB8LrX3NFaM_5fbfcd9a.jpg",
    logoSrc: "/assets/f1-logo_f600a2bc.png",
    featured: true,
  },
  {
    id: "cop30",
    ...
    image: "/assets/TV2kiYpzBOX0_2531b51f.jpg",
    logoSrc: "/assets/cop30-logo_3e7fc7df.png",
    featured: true,
  },
] as const;
